...
const Navbar = () => {
    ...
    const signOption = <>
        <NavLink to={'/signin'} className={`${isMenuOpen ? "block px-4 py-3 mb-3  text-xs text-center font-semibold leading-none bg-gray-50 hover:bg-gray-100 rounded-xl" : "hidden  lg:inline-block lg:ml-auto lg:mr-3 py-2 px-6 bg-gray-50 hover:bg-gray-100 text-sm text-gray-900 font-bold  rounded-xl transition duration-200 "}`} >Sign In</NavLink>
        <NavLink to={'/signup'} className={`${isMenuOpen ? "block px-4 py-3 mb-2 leading-loose text-xs text-center text-white font-semibold bg-blue-600 hover:bg-blue-700  rounded-xl" : "hidden lg:inline-block py-2 px-6 bg-blue-500 hover:bg-blue-600 text-sm text-white font-bold rounded-xl transition duration-200 "}`} >Sign up</NavLink>
    </>
