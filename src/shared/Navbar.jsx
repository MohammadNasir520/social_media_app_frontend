                ...
                <nav className="relative px-4 py-4 flex justify-between items-center bg-white">
                    ...
                    <ul className="hidden absolute top-1/2 left-1/2 transform -translate-y-1/2 -translate-x-1/2  lg:mx-auto lg:flex lg:items-center lg:w-auto lg:space-x-6">
                        ...
                        <li><NavLink className={({ isActive }) =>
                            isActive ? "text-blue-700 font-bold" : "text-sm text-gray-400 hover:text-gray-500"} to={'/'}>Home</NavLink></li>

                        <li><NavLink className={({ isActive }) =>
                            isActive ? "text-blue-700 font-bold" : "text-sm text-gray-400 hover:text-gray-500"} to={'/media'}>Media</NavLink></li>

                        <li><NavLink className={({ isActive }) =>
                            isActive ? "text-blue-700 font-bold" : "text-sm text-gray-400 hover:text-gray-500"} to={'/message'}>Message</NavLink></li>
                        <li><NavLink className={({ isActive }) =>
                            isActive ? "text-blue-700 font-bold" : "text-sm text-gray-400 hover:text-gray-500"} to={'/about'}>About</NavLink></li>
                    ...
                    <NavLink to={'/signup'} className="hidden lg:inline-block py-2 px-6 bg-blue-500 hover:bg-blue-600 text-sm text-white font-bold rounded-xl transition duration-200" >Sign up</NavLink>
                </nav>
